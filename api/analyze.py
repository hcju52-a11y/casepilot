...
[분석 전 필수 확인 — 이 순서를 반드시 따르세요]

**STEP 1: 진정요지 체크 항목 확인**
진정요지 란에서 "본인은 피진정인으로부터 ☑임금 □퇴직금 □기타..." 부분을 찾으세요.
- ☑ 또는 ✓ 표시가 된 항목 = 진정인이 실제 주장하는 사항 → 쟁점에 포함
- □ 빈 체크박스 항목 = 양식에 인쇄된 선택지일 뿐 → 쟁점에서 제외
- 예: ☑임금만 체크된 경우 → 임금체불만 분석. 퇴직금은 절대 언급 금지.

**STEP 2: 건설공사 난 확인**
진정서 하단에 "건설공사" 섹션(공사명칭, 현장소재지, 건설회사)이 기재되어 있으면 건설 사건으로 분석하세요.

**STEP 3: 초동분석 수행**
위에서 확인된 체크 항목만을 쟁점으로 하여 6개 섹션 형식으로 분석하세요.
문서에 기재된 금액, 기간, 당사자 정보를 정확히 반영하세요.
체크되지 않은 항목(퇴직금 등)은 사건 개요, 핵심 쟁점, 검토 포인트 어디에도 넣지 마세요."""
